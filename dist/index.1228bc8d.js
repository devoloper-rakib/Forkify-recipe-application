...
J=function(e){return null==e};var Q=TypeError;// `RequireObjectCoercible` abstract operation
// https://tc39.es/ecma262/#sec-requireobjectcoercible
B=function(e){if(J(e))throw Q("Can't call method on "+e);return e},q=function(e){return H(B(e))};var V={},Y={},K={},X={},Z={},ee="object"==typeof document&&document.all,et=(Z={all:ee,IS_HTMLDDA:void 0===ee&&void 0!==ee}).all;// `IsCallable` abstract operation
...
Y=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!K(r)||en(r))return r;throw eD("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
V=function(e){var t=Y(e,"string");return en(t)?t:t+""};var eW={},ez={},eU=O.document,eG=K(eU)&&K(eU.createElement);ez=function(e){return eG?eU.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tR(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;tE(a,o)}(e.sham||o&&o.sham)&&eJ(a,"sham",!0),e4(r,n,a,e)}};var tQ={},tV={},tY=Function.prototype,tK=tY.apply,tX=tY.call;// eslint-disable-next-line es/no-reflect -- safe
tV="object"==typeof Reflect&&Reflect.apply||(M?tX.bind(tK):function(){return tX.apply(tK,arguments)});var tZ={},t0={},t1=(t0=function(e){// Nashorn bug:
//   https://github.com/zloirock/core-js/issues/1128
//   https://github.com/zloirock/core-js/issues/1130
if("Function"===R(e))return N(e)})(t0.bind);// optional / simple context binding
tZ=function(e,t){return em(e),void 0===t?e:M?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t3={};t3=N([].slice);var t4={},t7=TypeError;t4=function(e,t){if(e<t)throw t7("Not enough arguments");return e};var t8={};// eslint-disable-next-line redos/no-vulnerable -- safe
t8=/(?:ipad|iphone|ipod).*applewebkit/i.test(eu);var t9={};t9="process"===R(O.process);var t5=O.setImmediate,t6=O.clearImmediate,re=O.process,rt=O.Dispatch,rr=O.Function,rn=O.MessageChannel,ri=O.String,ro=0,ra={},rs="onreadystatechange";L(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tV(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t9?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t8?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rf=(tQ={set:t5,clear:t6}).clear;// `clearImmediate` method
// http://w3c.github.io/setImmediate/#si-clearImmediate
S({global:!0,bind:!0,enumerable:!0,forced:O.clearImmediate!==rf},{clearImmediate:rf});var rp=tQ.set,rh={},rv={};/* global Bun -- Deno case */rv="function"==typeof Bun&&Bun&&"string"==typeof Bun.version;var rg=O.Function,rm=/MSIE .\./.test(eu)||rv&&((t=O.Bun.version.split(".")).length<3||"0"===t[0]&&(t[1]<3||"3"===t[1]&&"0"===t[2]));// IE9- / Bun 0.3.0- setTimeout / setInterval / setImmediate additional parameters fix
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timers
// https://github.com/oven-sh/bun/issues/1633
rh=function(e,t){var r=t?2:1;return rm?function(n,i/* , ...arguments */){var o=t4(arguments.length,1)>r,a=X(n)?n:rg(n),s=o?t3(arguments,r):[],c=o?function(){tV(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
...
(this.arg=t),v}},e}({});try{regeneratorRuntime=rb}catch(e){"object"==typeof globalThis?globalThis.regeneratorRuntime=rb:Function("r","regeneratorRuntime = r")(rb)}const r_="https://forkify-api.herokuapp.com/api/v2/recipes/",rw="64cf58a5-2bd6-4883-844b-b746d8daa023",rk=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},rE={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:11},bookmarks:[]},rS=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},rO=async function(e){let t=await rk(`${r_}/${e}?key=${rw}`);rE.recipe=rS(t);try{rE.bookmarks.some(t=>t.id===e)?rE.recipe.bookmarked=!0:rE.recipe.bookmarked=!1}catch(e){throw console.error(`${e} :(`),e}},r$=async function(e){try{rE.search.query=e;let t=await rk(`${r_}?search=${e}&key=${rw}`);rE.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),rE.search.page=1}catch(e){throw console.error(`${e} :(`),e}},rj=function(e=rE.search.page){rE.search.page=e;let t=(e-1)*rE.search.resultsPerPage,r=e*rE.search.resultsPerPage;return rE.search.results.slice(t,r)},rL=function(e){rE.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rE.recipe.servings;// newQt = oldQt * newServings / oldServings // 2 * 8 / 4 = 4 === newQt
}),rE.recipe.servings=e},rF=function(e){// Point : Add bookmark
rE.bookmarks.push(e),e.id===rE.recipe.id&&(rE.recipe.bookmarked=!0),rx()},rM=function(e){// Point : Delete bookmark
let t=rE.bookmarks.findIndex(t=>t.id===e);rE.bookmarks.splice(t,1),e===rE.recipe.id&&(rE.recipe.bookmarked=!1),rx()},rx=function(){localStorage.setItem("bookmarks",JSON.stringify(rE.bookmarks))};!function(){let e=localStorage.getItem("bookmarks");e&&(rE.bookmarks=JSON.parse(e))}();const rP=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());// const ingArr = ing[1].replaceAll(' ', '').split(',');
if(3!==t.length)throw Error("Wrong ingredient format! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t};console.log(r);let n=await rk(`${r_}?key=${rw}`,r);rE.recipe=rS(n),rF(rE.recipe)}catch(e){throw e}};var rT={};rT=new URL(E("dRo73").resolve("iVQ3h"),import.meta.url).toString();class rI{// Point : Private variable
_data;/**
...
},y=Fraction;class rq extends rI{// Point : Private property
...
<figure class="recipe__fig">
		...
		<div class="recipe__details">
          ...
          <div class="recipe__user-generated ${this._data.key?"":"hidden"}">
           <svg> <use href="${/*@__PURE__*/_(rT)}#icon-user"></use> </svg>          
          </div>
		...
		`}_generateMarkupIngredient(e){return`
			...
			`}}var rH=new rq;class rN{// Private variable
_parentElement=document.querySelector(".search");// Public method
getQuery(){let e=this._parentElement.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentElement.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rA=new rN,rC=new class extends rI{// Point : Private property
_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
    ...
    `}};class rD extends rI{// Point : Private property
_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again ;)";_message="";_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rR=new rD;class rW extends rI{// Point : Private property
_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rz=new rW;// Task : Refactor the markup for generateMarkup() method ( like btn--prev and btn--next )
class rU extends rI{// Point : Private property
...
1===e&&t>1?`
		  ...
		  `:e===t&&t>1?`
			...
			`:"")}}var rG=new rU;class rB extends rI{// Point :  Private property
...
addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rJ=new rB;console.log("controller.js working...");// Point : declare variable
...
const rQ=async function(){// Point : loading recipe ( try catch finally )
try{let e=window.location.hash.slice(1);if(!e)return;/// Point : Guard clause
rH.renderSpinner(),rR.update(rj()),rz.update(rE.bookmarks),// Loading recipe
await rO(e),rH.render(rE.recipe)}catch(e){rH.renderError(),console.error(`${e} :(`)}},rV=async function(){try{rR.renderSpinner();// Point 1 : Get search query
let e=rA.getQuery();if(!e)return;/// Point : Guard clause
// Point 2 : Load Search Results
await r$(e),rR.render(rj()),rG.render(rE.search)}catch(e){console.log(e)}},rY=async function(e){try{rJ.renderSpinner(),// Point : Upload the new recipe data
await rP(e),console.log(rE.recipe),rH.render(rE.recipe),rJ.renderMessage(),rz.render(rE.bookmarks),// Point : Change ID in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),// Point : Close form window
setTimeout(function(){rJ.toggleWIndow()},2500)}catch(e){console.error(`${e} :(`),rJ.renderError(e.message)}};rz.addHandlerRender(function(){rz.render(rE.bookmarks)}),rH.addHandlerRender(rQ),rH.addHandlerUpdateServings(function(e){// Point : Update the recipe servings (in state)
rL(e),rH.update(rE.recipe)}),rH.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rM(rE.recipe.id):rF(rE.recipe),rH.update(rE.recipe),rz.render(rE.bookmarks);// Point : 4) Render initial pagination buttons
// Point : 5) Update bookmark view
}),rA.addHandlerSearch(rV),rG.addHandlerClick(function(e){rR.render(rj(e)),rG.render(rE.search)}),rJ.addHandlerUpload(rY);